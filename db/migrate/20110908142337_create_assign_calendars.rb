...
class CreateAssignCalendars < ActiveRecord::Migration
  def self.up
    create_table :assign_calendars do |t|
      t.column :user_id, :integer
      t.column :calendar_id, :integer
      t.column :one_calendar, :boolean, :default => true
    end
  end

  def self.down
    drop_table :assign_calendars
  end
end
